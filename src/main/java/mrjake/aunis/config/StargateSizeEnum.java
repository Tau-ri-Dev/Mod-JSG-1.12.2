...
public enum StargateSizeEnum {
  ...
  LARGE(2, "Large", 1, 0, new AunisAxisAlignedBB(-3.5, 1.5, -0.1, 3.5, 8.6, 0.2), new AunisAxisAlignedBB(-1.5, 3.5, 0.5, 1.5, 7, 6.5), 6, Arrays.asList(new AunisAxisAlignedBB(-2.5, 2.0, -0.5, 2.5, 9, 0.5), new AunisAxisAlignedBB(-3.5, 2.0, -0.5, -2.5, 8, 0.5), new AunisAxisAlignedBB(3.5, 2.0, -0.5, 2.5, 8, 0.5)));
