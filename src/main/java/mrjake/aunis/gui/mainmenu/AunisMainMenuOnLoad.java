...
public class AunisMainMenuOnLoad extends AunisMainMenu {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if(isGameLoaded)
            this.mc.displayGuiScreen(new AunisMainMenu());
    ...
    public void initGui() {
        ...
        // toggle
        this.anyButton.add(new AunisGuiButton(0, 0, 0, width, height, "Continue"));
