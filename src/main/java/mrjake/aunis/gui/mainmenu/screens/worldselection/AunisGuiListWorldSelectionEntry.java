...
import mrjake.aunis.gui.mainmenu.screens.options.resourcepacks.AunisGuiListExtended;
...
public class AunisGuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry{
    private static final Logger LOGGER = LogManager.getLogger();
    private static final DateFormat DATE_FORMAT = new SimpleDateFormat();
    private static final ResourceLocation ICON_MISSING = new ResourceLocation("textures/misc/unknown_server.png");
    private static final ResourceLocation ICON_OVERLAY_LOCATION = new ResourceLocation("textures/gui/world_selection.png");
    private final Minecraft client;
    private final AunisSinglePlayerGui worldSelScreen;
    private final WorldSummary worldSummary;
    private final ResourceLocation iconLocation;
    private final AunisGuiListWorldSelection containingListSel;
    private File iconFile;
    private DynamicTexture icon;
    private long lastClickTime;

    public AunisGuiListWorldSelectionEntry(AunisGuiListWorldSelection listWorldSelIn, WorldSummary worldSummaryIn, ISaveFormat saveFormat)
    {
        ...
        if (this.worldSummary.askToOpenWorld())
        {
            this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
            {
                public void confirmClicked(boolean result, int id)
                {
                    if (result)
                    {
                        AunisGuiListWorldSelectionEntry.this.loadWorld();
                    }
                    else
                    {
                        AunisGuiListWorldSelectionEntry.this.client.displayGuiScreen(AunisGuiListWorldSelectionEntry.this.worldSelScreen);
                    }
                }
    ...
    public void deleteWorld()
    {
        this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
        {
            public void confirmClicked(boolean result, int id)
            {
                if (result)
                {
                    AunisGuiListWorldSelectionEntry.this.client.displayGuiScreen(new GuiScreenWorking());
                    ISaveFormat isaveformat = AunisGuiListWorldSelectionEntry.this.client.getSaveLoader();
                    isaveformat.flushCache();
                    isaveformat.deleteWorldDirectory(AunisGuiListWorldSelectionEntry.this.worldSummary.getFileName());
                    AunisGuiListWorldSelectionEntry.this.containingListSel.refreshList();
                }
