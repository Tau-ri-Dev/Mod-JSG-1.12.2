package mrjake.aunis.gui.mainmenu.screens.serverlist;
...
public class AunisServerListEntryNormal extends ServerListEntryNormal
{
    ...
    protected AunisServerListEntryNormal(GuiMultiplayer ownerIn, ServerData serverIn) {
        ...
        if (!this.server.pinged)
        {
            ...
            EXECUTOR.submit(new Runnable()
            {
                public void run()
                {
                    try
                    {
                        AunisServerListEntryNormal.this.owner.getOldServerPinger().ping(AunisServerListEntryNormal.this.server);
                    }
                    catch (UnknownHostException var2)
                    {
                        AunisServerListEntryNormal.this.server.pingToServer = -1L;
                        AunisServerListEntryNormal.this.server.serverMOTD = TextFormatting.DARK_RED + I18n.format("multiplayer.status.cannot_resolve");
                    }
                    catch (Exception var3)
                    {
                        AunisServerListEntryNormal.this.server.pingToServer = -1L;
                        AunisServerListEntryNormal.this.server.serverMOTD = TextFormatting.DARK_RED + I18n.format("multiplayer.status.cannot_connect");
                    }
                }
            });
        }
