...
public class AunisServerListEntryLanDetected extends ServerListEntryLanDetected{
    private final AunisMultiPlayerGui screen;
    protected final Minecraft mc;
    protected final LanServerInfo serverData;
    private long lastClickTime;

    protected AunisServerListEntryLanDetected(AunisMultiPlayerGui p_i47141_1_, LanServerInfo p_i47141_2_) {
