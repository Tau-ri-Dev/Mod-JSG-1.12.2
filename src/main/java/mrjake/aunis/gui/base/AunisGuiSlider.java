...
public class AunisGuiSlider extends AunisGuiButton
{
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            drawRect(this.xpos + (int)(this.sliderValue * (float)(this.width - 8)), this.ypos, this.xpos + (int)(this.sliderValue * (float)(this.width - 8)) + 8, this.ypos + 20, AunisGuiBase.FRAME_COLOR);
        }
    }
