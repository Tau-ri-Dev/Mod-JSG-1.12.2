...
public enum SoundEventEnum implements EnumKeyInterface<Integer> {
    ...
    GATE_PEGASUS_CHEVRON_OPEN(82, "gate_pegasus_chevron_open", 0.2f),
    ...
    RINGS_PLATFORM_GOAULD_OPEN(102, "platform_goauld_open", 0.5f),
    RINGS_PLATFORM_GOAULD_CLOSE(103, "platform_goauld_close", 0.5f),
