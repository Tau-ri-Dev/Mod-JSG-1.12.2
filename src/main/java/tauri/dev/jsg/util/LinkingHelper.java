...
public class LinkingHelper {
    ...
    public static TileEntity findClosestTile(World world, BlockPos startPos, Block[] allowedBlocks, Class<? extends TileEntity> tileClass, int radiusXZ, int radiusY) {
        BlockPos found = null;
        TileEntity tileEntity = null;

        ArrayList<BlockPos> blacklist = new ArrayList<>();
        while (found == null) {
            found = LinkingHelper.findClosestPos(world, startPos, new BlockPos(radiusXZ, radiusY, radiusXZ), allowedBlocks, blacklist);
            if (found == null) break;
