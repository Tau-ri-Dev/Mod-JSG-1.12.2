...
import tauri.dev.jsg.creativetabs.*;

public class JSGCreativeTabsHandler {
    public static final JSGGatesCreativeTab jsgGatesCreativeTab = new JSGGatesCreativeTab();
    public static final JSGRingsCreativeTab jsgRingsCreativeTab = new JSGRingsCreativeTab();
