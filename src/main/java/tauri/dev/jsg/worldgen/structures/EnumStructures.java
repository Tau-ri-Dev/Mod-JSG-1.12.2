...
public enum EnumStructures {
    ...
    ANCIENT_TOTEM("ancient_totem", 0, false, false, null, 3, 3, 0, false, JSGConfig.WorldGen.structures.structuresRandomGeneratorEnabled, 0.00008f, new OverworldProcessor(),
            new ArrayList<Block>(){{
                add(Blocks.GRASS);
                add(Blocks.SAND);
                add(Blocks.STONE);
