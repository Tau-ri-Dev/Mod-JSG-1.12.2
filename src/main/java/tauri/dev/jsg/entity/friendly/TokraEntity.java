...
public class TokraEntity extends JSGTradeableEntity implements IRangedAttackMob, INpc {
    ...
    private final ItemStack ZAT_ITEM = new ItemStack(JSGItems.ZAT);
    private final ItemStack STAFF_ITEM = new ItemStack(JSGItems.STAFF);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor) {
        if (this.getHeldItem(EnumHand.MAIN_HAND).getItem() instanceof EnergyWeapon) {
            ...
            world.spawnEntity(JSGEnergyProjectile.createEnergyBall(world, this, target, item));
        }
    }
