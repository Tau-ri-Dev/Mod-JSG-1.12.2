...
public class OCAddMessageGui extends GuiScreen {
	...
	public void initGui() {		
		...
		String[] labels = {
				"item.jsg.universe_dialer.oc_name",
				"item.jsg.universe_dialer.oc_address",
				"item.jsg.universe_dialer.oc_port",
				"item.jsg.universe_dialer.oc_data"
		};
		...
		saveButton = new GuiButton(0, guiLeft+20, guiTop+170, I18n.format("item.jsg.universe_dialer.oc_save"));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (isPortInvalid)
			drawString(fontRenderer, TextFormatting.DARK_RED + I18n.format("item.jsg.universe_dialer.oc_port_invalid"), guiLeft+245, guiTop+103, 0x00FFFFFF);
	}
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		JSGPacketHandler.INSTANCE.sendToServer(new ItemOCProgramToServer(hand, message));
