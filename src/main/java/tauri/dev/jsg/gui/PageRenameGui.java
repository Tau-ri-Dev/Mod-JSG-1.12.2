...
public class PageRenameGui extends GuiScreen {
	...
	public void initGui() {
		...
		saveButton = new GuiButton(0, guiLeft+20, guiTop+13+18+12, I18n.format("item.jsg.universe_dialer.oc_save"));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		JSGPacketHandler.INSTANCE.sendToServer(new PageNotebookSetNameToServer(hand, name));
