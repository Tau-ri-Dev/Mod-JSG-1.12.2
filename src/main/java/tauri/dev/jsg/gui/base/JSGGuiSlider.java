...
public class JSGGuiSlider extends JSGGuiButton
{
    ...
    public JSGGuiSlider(int buttonId, int x, int y, GameSettings.Options optionIn)
    {
        this(buttonId, x, y, optionIn, 0.0F, 1.0F);
    }

    public JSGGuiSlider(int buttonId, int x, int y, GameSettings.Options optionIn, float minValueIn, float maxValue)
    {
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            drawRect(this.xpos + (int)(this.sliderValue * (float)(this.width - 8)), this.ypos, this.xpos + (int)(this.sliderValue * (float)(this.width - 8)) + 8, this.ypos + 20, JSGGuiBase.FRAME_COLOR);
        }
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        if (this.visible) {
            ...
            drawRect(x, y, x+width, y+height, JSGGuiBase.FRAME_COLOR);
