...
import tauri.dev.jsg.gui.mainmenu.screens.serverlist.JSGServerListEntryLanDetected;
import tauri.dev.jsg.gui.mainmenu.screens.serverlist.JSGServerListEntryNormal;
...
public class JSGMultiPlayerGui extends GuiMultiplayer {
    ...
    public JSGMultiPlayerGui(GuiScreen parentScreen, BiomeOverlayEnum overlay) {
        super(parentScreen);
    ...
    protected static final ResourceLocation BACKGROUND_TEXTURE = JSGConfig.mainMenuConfig.disableJSGMainMenu ? null : new ResourceLocation(JSG.MOD_ID, "textures/gui/mainmenu/background.jpg");
    ...
    public void createButtons(){
        jsgButtonList.clear();
        btnEditServer = new JSGGuiButton(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit"));
        btnDeleteServer = new JSGGuiButton(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete"));
        btnSelectServer = new JSGGuiButton(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("selectServer.select"));
        jsgButtonList.add(new JSGGuiButton(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("selectServer.direct")));
        jsgButtonList.add(new JSGGuiButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.add")));
        jsgButtonList.add(new JSGGuiButton(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh")));
        jsgButtonList.add(new JSGGuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof JSGServerListEntryNormal)
            {
                String s4 = ((JSGServerListEntryNormal)guilistextended$iguilistentry).getServerData().serverName;
            ...
            else if (button.id == 7 && guilistextended$iguilistentry instanceof JSGServerListEntryNormal)
            {
                this.editingServer = true;
                ServerData serverdata = ((JSGServerListEntryNormal)guilistextended$iguilistentry).getServerData();
    ...
    {
        this.mc.displayGuiScreen(new JSGMultiPlayerGui(lastScreen, overlay));
    }
    ...
    public void confirmClicked(boolean result, int id)
    {
        ...
        if (this.deletingServer)
        {
            ...
            if (result && guilistextended$iguilistentry instanceof JSGServerListEntryNormal)
            {
    ...
    public void connectToSelected()
    {
        ...
        if (guilistextended$iguilistentry instanceof JSGServerListEntryNormal)
        {
            this.connectToServer(((JSGServerListEntryNormal)guilistextended$iguilistentry).getServerData());
        }
        else if (guilistextended$iguilistentry instanceof JSGServerListEntryLanDetected)
        {
            LanServerInfo lanserverinfo = ((JSGServerListEntryLanDetected)guilistextended$iguilistentry).getServerData();
