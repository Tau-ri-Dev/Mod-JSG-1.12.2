...
import tauri.dev.jsg.gui.mainmenu.screens.options.resourcepacks.JSGGuiResourcePackSelected;
import tauri.dev.jsg.gui.mainmenu.screens.options.resourcepacks.JSGGuiResourcePacksAvailable;
...
public class JSGResourcePacksOptions extends GuiScreenResourcePacks {

    public JSGResourcePacksOptions(GuiScreen parentScreenIn, BiomeOverlayEnum overlay) {
    ...
    protected static JSGGuiResourcePacksAvailable availableResourcePacksList;
    protected static JSGGuiResourcePackSelected selectedResourcePacksList;
    ...
    public void initGui()
    {
        ...
        jsgButtonList.add(new JSGGuiButton(2, this.width / 2 - 205, this.height - 38, I18n.format("resourcePack.openFolder")));
        jsgButtonList.add(new JSGGuiButton(1, this.width / 2 + 5, this.height - 38, I18n.format("gui.done")));
        ...
        availableResourcePacksList = new JSGGuiResourcePacksAvailable(this.mc, 200, this.height, availableResourcePacks);
        availableResourcePacksList.setSlotXBoundsFromLeft(this.width / 2 - 4 - 200);
        availableResourcePacksList.registerScrollButtons(7, 8);
        selectedResourcePacksList = new JSGGuiResourcePackSelected(this.mc, 200, this.height, selectedResourcePacks);
