 ...
 *
 */
public class JSGGuiSlotModList extends JSGGuiScrollingList
{

    private static final ResourceLocation VERSION_CHECK_ICONS = new ResourceLocation(ForgeVersion.MOD_ID, "textures/gui/version_check_icons.png");

    private final JSGModListGui parent;
    private final ArrayList<ModContainer> mods;

    public JSGGuiSlotModList(JSGModListGui parent, ArrayList<ModContainer> mods, int listWidth, int slotHeight)
    {
