...
public class JSGAudioOptions extends GuiScreenOptionsSounds {
    ...
    public JSGAudioOptions(GuiScreen parentIn, GameSettings settingsIn, BiomeOverlayEnum overlay){
    ...
    public void initGui()
    {
        ...
        int i = 0;
        jsgButtonList.clear();
        this.jsgButtonList.add(new JSGAudioOptions.Button(SoundCategory.MASTER.ordinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), SoundCategory.MASTER, true));
        i = i + 2;
        ...
        for (SoundCategory soundcategory : SoundCategory.values())
        {
            ...
            {
                this.jsgButtonList.add(new JSGAudioOptions.Button(soundcategory.ordinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), soundcategory, false));
                ++i;
            }
        }
        ...
        ++i;
        this.jsgButtonList.add(new JSGOptionButton(201, this.width / 2 - 100, k + 24 * (i >> 1), GameSettings.Options.SHOW_SUBTITLES, this.game_settings_4.getKeyBinding(GameSettings.Options.SHOW_SUBTITLES)));
    ...
    class Button extends JSGGuiSliderSounds
    {
        ...
        public Button(int buttonId, int x, int y, SoundCategory categoryIn, boolean master)
        {
            ...
            this.displayString = this.categoryName + ": " + JSGAudioOptions.this.getDisplayString(categoryIn);
            this.volume = JSGAudioOptions.this.game_settings_4.getSoundLevel(categoryIn);
        }
        ...
        protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
        {
            if (this.visible)
            {
                if (this.pressed)
                {
                    ...
                    this.displayString = this.categoryName + ": " + JSGAudioOptions.this.getDisplayString(this.category);
                }

                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                //this.drawTexturedModalRect(this.x + (int)(this.volume * (float)(this.width - 8)), this.y, 0, 66, 4, 20);
                drawRect(this.x + (int)(this.volume * (float)(this.width - 8)), this.y, this.x + (int)(this.volume * (float)(this.width - 8)) + 8, this.y + 20, JSGGuiBase.FRAME_COLOR);
            }
        }
        ...
        public void mouseReleased(int mouseX, int mouseY)
        {
            if (this.pressed)
            {
                JSGAudioOptions.this.mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
            }
