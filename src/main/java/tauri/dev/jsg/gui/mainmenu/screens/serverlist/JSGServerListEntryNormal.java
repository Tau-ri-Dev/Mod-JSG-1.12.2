...
public class JSGServerListEntryNormal extends ServerListEntryNormal
{
    ...
    protected JSGServerListEntryNormal(GuiMultiplayer ownerIn, ServerData serverIn) {
        ...
        if (!this.server.pinged)
        {
            ...
            EXECUTOR.submit(new Runnable()
            {
                public void run()
                {
                    try
                    {
                        JSGServerListEntryNormal.this.owner.getOldServerPinger().ping(JSGServerListEntryNormal.this.server);
                    }
                    catch (UnknownHostException var2)
                    {
                        JSGServerListEntryNormal.this.server.pingToServer = -1L;
                        JSGServerListEntryNormal.this.server.serverMOTD = TextFormatting.DARK_RED + I18n.format("multiplayer.status.cannot_resolve");
                    }
                    catch (Exception var3)
                    {
                        JSGServerListEntryNormal.this.server.pingToServer = -1L;
                        JSGServerListEntryNormal.this.server.serverMOTD = TextFormatting.DARK_RED + I18n.format("multiplayer.status.cannot_connect");
                    }
                }
            });
        }
