package tauri.dev.jsg.gui.mainmenu.screens.loadingworld;
...
public class JSGGuiLoadingWorld extends LoadingScreenRenderer {
    ...
    public JSGGuiLoadingWorld(Minecraft mcIn) {
        super(mcIn);
        this.mc = mcIn;
    ...
    protected static final ResourceLocation BACKGROUND_TEXTURE =
            JSGConfig.mainMenuConfig.disableJSGMainMenu ? null :
