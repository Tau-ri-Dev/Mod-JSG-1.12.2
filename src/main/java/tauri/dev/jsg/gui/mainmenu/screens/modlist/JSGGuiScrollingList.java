package tauri.dev.jsg.gui.mainmenu.screens.modlist;
...
public abstract class JSGGuiScrollingList extends GuiScrollingList
{
    ...
    public JSGGuiScrollingList(Minecraft client, int width, int height, int top, int bottom, int left, int entryHeight)
    {
        this(client, width, height, top, bottom, left, entryHeight, width, height);
    }
    public JSGGuiScrollingList(Minecraft client, int width, int height, int top, int bottom, int left, int entryHeight, int screenWidth, int screenHeight)
    {
