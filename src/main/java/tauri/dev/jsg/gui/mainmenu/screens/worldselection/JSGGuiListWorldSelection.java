...
public class JSGGuiListWorldSelection extends GuiListExtended {
    private static final Logger LOGGER = LogManager.getLogger();
    private final JSGSinglePlayerGui worldSelection;
    private final List<JSGGuiListWorldSelectionEntry> entries = Lists.<JSGGuiListWorldSelectionEntry>newArrayList();
    private int selectedIdx = -1;

    public JSGGuiListWorldSelection(JSGSinglePlayerGui p_i46590_1_, Minecraft clientIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn) {
    ...
    public void refreshList()
    {
        ...
        {
            this.entries.add(new JSGGuiListWorldSelectionEntry(this, worldsummary, this.mc.getSaveLoader()));
        }
    }

    @Override
    public JSGGuiListWorldSelectionEntry getListEntry(int index)
    {
    ...
    @Nullable
    public JSGGuiListWorldSelectionEntry getSelectedWorld()
    {
        return this.selectedIdx >= 0 && this.selectedIdx < this.getSize() ? this.getListEntry(this.selectedIdx) : null;
    }

    public JSGSinglePlayerGui getGuiWorldSelection()
    {
