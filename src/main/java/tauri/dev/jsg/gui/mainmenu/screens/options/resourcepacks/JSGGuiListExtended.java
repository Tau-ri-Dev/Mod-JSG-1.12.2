...
public abstract class JSGGuiListExtended extends JSGGuiSlot {
    public JSGGuiListExtended(Minecraft mcIn, int width, int height, int topIn, int bottomIn, int slotHeightIn) {
