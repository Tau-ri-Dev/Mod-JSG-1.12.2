package tauri.dev.jsg.gui.mainmenu.screens.worldselection;

import tauri.dev.jsg.gui.mainmenu.screens.JSGSinglePlayerGui;
...
public class JSGGuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry{
    private static final Logger LOGGER = LogManager.getLogger();
    private static final DateFormat DATE_FORMAT = new SimpleDateFormat();
    private static final ResourceLocation ICON_MISSING = new ResourceLocation("textures/misc/unknown_server.png");
    private static final ResourceLocation ICON_OVERLAY_LOCATION = new ResourceLocation("textures/gui/world_selection.png");
    private final Minecraft client;
    private final JSGSinglePlayerGui worldSelScreen;
    private final WorldSummary worldSummary;
    private final ResourceLocation iconLocation;
    private final JSGGuiListWorldSelection containingListSel;
    private File iconFile;
    private DynamicTexture icon;
    private long lastClickTime;

    public JSGGuiListWorldSelectionEntry(JSGGuiListWorldSelection listWorldSelIn, WorldSummary worldSummaryIn, ISaveFormat saveFormat)
    {
        ...
        if (this.worldSummary.askToOpenWorld())
        {
            this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
            {
                public void confirmClicked(boolean result, int id)
                {
                    if (result)
                    {
                        JSGGuiListWorldSelectionEntry.this.loadWorld();
                    }
                    else
                    {
                        JSGGuiListWorldSelectionEntry.this.client.displayGuiScreen(JSGGuiListWorldSelectionEntry.this.worldSelScreen);
                    }
                }
    ...
    public void deleteWorld()
    {
        this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
        {
            public void confirmClicked(boolean result, int id)
            {
                if (result)
                {
                    JSGGuiListWorldSelectionEntry.this.client.displayGuiScreen(new GuiScreenWorking());
                    ISaveFormat isaveformat = JSGGuiListWorldSelectionEntry.this.client.getSaveLoader();
                    isaveformat.flushCache();
                    isaveformat.deleteWorldDirectory(JSGGuiListWorldSelectionEntry.this.worldSummary.getFileName());
                    JSGGuiListWorldSelectionEntry.this.containingListSel.refreshList();
                }
