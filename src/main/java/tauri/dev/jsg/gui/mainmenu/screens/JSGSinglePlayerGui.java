...
import tauri.dev.jsg.gui.mainmenu.screens.worldselection.JSGGuiListWorldSelection;
import tauri.dev.jsg.gui.mainmenu.screens.worldselection.JSGGuiListWorldSelectionEntry;
...
public class JSGSinglePlayerGui extends GuiWorldSelection {
    public JSGSinglePlayerGui(GuiScreen screenIn, BiomeOverlayEnum overlay) {
        super(screenIn);
    ...
    private JSGGuiButton deleteButton;
    private JSGGuiButton selectButton;
    private JSGGuiButton renameButton;
    private JSGGuiButton copyButton;
    private JSGGuiListWorldSelection selectionList;
    ...
    public void initGui() {
        ...
        this.selectionList = new JSGGuiListWorldSelection(this, this.mc, this.width, this.height, 32, this.height - 64, 36);
        this.postInit();
    }
    ...
    public void postInit() {
        jsgButtonList.clear();
        selectButton = new JSGGuiButton(1, this.width / 2 - 154, this.height - 52, 150, 20, I18n.format("selectWorld.select"));
        jsgButtonList.add(new JSGGuiButton(3, this.width / 2 + 4, this.height - 52, 150, 20, I18n.format("selectWorld.create")));
        renameButton = new JSGGuiButton(4, this.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.edit"));
        deleteButton = new JSGGuiButton(2, this.width / 2 - 76, this.height - 28, 72, 20, I18n.format("selectWorld.delete"));
        copyButton = new JSGGuiButton(5, this.width / 2 + 4, this.height - 28, 72, 20, I18n.format("selectWorld.recreate"));
        jsgButtonList.add(new JSGGuiButton(0, this.width / 2 + 82, this.height - 28, 72, 20, I18n.format("gui.cancel")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            JSGGuiListWorldSelectionEntry guilistworldselectionentry = this.selectionList.getSelectedWorld();
    ...
    public void selectWorld(@Nullable JSGGuiListWorldSelectionEntry entry) {
