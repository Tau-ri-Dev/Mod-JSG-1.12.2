...
public class JSGServerListEntryLanDetected extends ServerListEntryLanDetected{
    private final JSGMultiPlayerGui screen;
    protected final Minecraft mc;
    protected final LanServerInfo serverData;
    private long lastClickTime;

    protected JSGServerListEntryLanDetected(JSGMultiPlayerGui p_i47141_1_, LanServerInfo p_i47141_2_) {
