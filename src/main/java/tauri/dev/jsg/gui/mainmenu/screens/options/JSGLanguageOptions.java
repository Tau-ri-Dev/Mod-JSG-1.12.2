...
public class JSGLanguageOptions extends GuiLanguage {
    public JSGLanguageOptions(GuiScreen screen, GameSettings gameSettingsObj, LanguageManager manager, BiomeOverlayEnum overlay) {
    ...
    public void initGui()
    {
        ...
        jsgButtonList.clear();
        jsgButtonList.add(new JSGOptionButton(100, this.width / 2 - 205, this.height - 38, GameSettings.Options.FORCE_UNICODE_FONT, this.game_settings_3.getKeyBinding(GameSettings.Options.FORCE_UNICODE_FONT)));
        jsgButtonList.add(new JSGGuiButton(6, this.width / 2 + 5, this.height - 38, I18n.format("gui.done")));
        this.list = new JSGLanguageOptions.List(this.mc);
        ...
        if (button.enabled)
        {
            switch (button.id)
            {
                ...
                case 100:
                    ...
                    if (button instanceof JSGOptionButton)
                    {
                        this.game_settings_3.setOptionValue(((JSGOptionButton)button).getOption(), 1);
    ...
    public class List extends GuiSlot {
        ...
        {
            super(mcIn, JSGLanguageOptions.this.width, JSGLanguageOptions.this.height, 32, JSGLanguageOptions.this.height - 65 + 4, 18);

            for (Language language : JSGLanguageOptions.this.languageManager.getLanguages())
            {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            ...
            JSGLanguageOptions.this.game_settings_3.language = language.getLanguageCode();
        ...
        {
            return ((String)this.langCodeList.get(slotIndex)).equals(JSGLanguageOptions.this.languageManager.getCurrentLanguage().getLanguageCode());
        }
        ...
        protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks)
        {
            ...
            fontRenderer.setBidiFlag(JSGLanguageOptions.this.languageManager.getCurrentLanguage().isBidirectional());
        }
    }
}
