...
import tauri.dev.jsg.renderer.props.DestinyBearingRenderer;
...
public class DestinyBearingBlock extends JSGBlock {
    public static final String BLOCK_NAME = "destiny_bearing_block";
    ...
    public TileEntity createTileEntity(@Nonnull World world, @Nonnull IBlockState state) {
        return new DestinyBearingTile();
    }

    public Class<? extends TileEntity> getTileEntityClass() {
        return DestinyBearingTile.class;
    }

    @SideOnly(Side.CLIENT)
    public TileEntitySpecialRenderer<? extends TileEntity> getTESR() {
        return new DestinyBearingRenderer();
    }
