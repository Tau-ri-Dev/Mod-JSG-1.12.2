...
import tauri.dev.jsg.renderer.props.DestinyChevronRenderer;
...
public class DestinyChevronBlock extends JSGBlock {
    public static final String BLOCK_NAME = "destiny_chevron_block";

    public DestinyChevronBlock() {
        super(Material.IRON);
    ...
    public TileEntity createTileEntity(@Nonnull World world, @Nonnull IBlockState state) {
        return new DestinyChevronTile();
    }

    public Class<? extends TileEntity> getTileEntityClass() {
        return DestinyChevronTile.class;
    }

    @SideOnly(Side.CLIENT)
    public TileEntitySpecialRenderer<? extends TileEntity> getTESR() {
        return new DestinyChevronRenderer();
    }
