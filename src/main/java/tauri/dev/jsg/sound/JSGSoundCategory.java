 ...
 * Developers of JSG are not creators of this class file
 */
...
public class JSGSoundCategory {
    ...
    private static final JSGSoundCategory instance = new JSGSoundCategory();

    private JSGSoundCategory() {}

    public static JSGSoundCategory getInstance() {return instance;}
