...
public class JSGSoundHelperClient {
	...
	private static PositionedSoundRecord getSoundRecord(SoundPositionedEnum soundEnum, BlockPos pos) {
		return new PositionedSoundRecord(soundEnum.resourceLocation, soundEnum.soundCategory, soundEnum.volume * JSGConfig.avConfig.volume * 5f, 1.0f, soundEnum.repeat, 0, ISound.AttenuationType.LINEAR, pos.getX()+0.5f, pos.getY()+0.5f, pos.getZ()+0.5f);
	}
