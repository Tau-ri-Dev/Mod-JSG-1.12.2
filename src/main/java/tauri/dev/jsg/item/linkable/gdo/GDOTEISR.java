...
public class GDOTEISR extends TileEntityItemStackRenderer {
    ...
    public void renderByItem(ItemStack stack) {
        ...
        TransformType transformType = JSGItems.GDO.getLastTransform();
        ...
        if (transformType == TransformType.FIXED) {
            ...
            boolean mainhand = JSGItems.GDO.getLastTransform() == TransformType.FIRST_PERSON_RIGHT_HAND;
    ...
    private static void drawStringWithShadow(float x, float y, String text, boolean active, boolean red) {
        ...
        if (active) {
            ...
            JSGFontRenderer.getFontRenderer().drawString(text, -6, 19, 0x606060, false);
        }
